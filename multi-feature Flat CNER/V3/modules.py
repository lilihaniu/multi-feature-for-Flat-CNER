...
class Four_Pos_Fusion_Embedding(nn.Module):
    def __init__(self,pe, num_heads,four_pos_fusion,pe_ss,pe_se,pe_es,pe_ee,max_seq_len,hidden_size,mode):
        super().__init__()
        self.mode = mode
    ...
    def __init__(self, hidden_size, num_heads,
        ...
        if self.four_pos_fusion_embedding is None:
            self.four_pos_fusion_embedding = \
                Four_Pos_Fusion_Embedding(self.pe, num_heads,self.four_pos_fusion,self.pe_ss,self.pe_se,self.pe_es,self.pe_ee,
